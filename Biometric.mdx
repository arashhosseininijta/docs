...
<Update label="September 2025 Release" description="Voice Harbor V4">
  <Frame>
    <img className="block" src="/images/vh4.png" />
    <video id="biovh4" autoPlay controls loop muted playsInline>
      <source src="/images/vh4.mp4" type="video/mp4" />
  ...
  | Processing Speed     | ~1.5× RTF                  | Mini: <0.5×, Advanced: ~0.75× |
