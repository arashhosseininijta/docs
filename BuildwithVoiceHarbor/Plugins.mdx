...
description: 'Enjoy Voice Harbor inside Avid Pro Tools'
icon: 'key'
---
...
<CardGroup cols={1}>
  <Card
    title="Access Voice Harbor AAX Plugin"
    icon="key"
...
🔌 Requires an active internet connection to communicate with the secure VoiceHarbor.ai API for anonymization.
