...
<details>
  <summary>Configure Your Task</summary>
  ...
  ### 3. Diarization
  <input type="checkbox" id="diarization" /> Enable Diarization
  ...
  <button onclick="generateParameters()">Generate Parameters</button>

  ### Generated Configuration:
  <pre id="generatedParameters"></pre>

  <script>
    function generateParameters() {
      var task = document.getElementById('task').value;
      var language = document.getElementById('language').value;
      var diarization = document.getElementById('diarization').checked ? "Enabled" : "Disabled";
      var model = document.getElementById('model').value;
      
      var parameters = `Task: ${task}\nLanguage: ${language}\nDiarization: ${diarization}\nModel: ${model}`;
      
      document.getElementById('generatedParameters').textContent = parameters;
    }
  </script>
