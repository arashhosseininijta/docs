...
Transcirption is by **default** applied for the task **protect**. To have the transcription without any reduction use the **task** parameter as set it to **transcribe**.  
...
### Set traget transcription language
