...
<Steps>
  <Step title="Token Managment.">
    [Use your ADMIN_TOKEN to create USAGE_TOKEN(s)](https://docs.nijta.com/api-reference/admin/developer-token).
  </Step>
  <Step title="Submision Managment.">
    [Use the USAGE_TOKEN to create a job.](https://docs.nijta.com/api-reference/jobs/create)
    [Select parameters.](https://docs.nijta.com/BuildwithVoiceHarbor/JobParameters#parameters) and 
    [Submit your file(s).](https://docs.nijta.com/api-reference/files/upload-url)
  </Step>
  <Step title="Download protected audio and trascription.">
    Use your USAGE_TOKEN and JOB_ID to download the results.
  </Step>
</Steps>
