...
<Steps>
  <Step title="Token Managment.">
    [Use your admin token to create usage token(s)](https://docs.nijta.com/api-reference/admin/developer-token).
  </Step>
  <Step title="Submision Managment.">
    [Use the usage token to create a job.](https://docs.nijta.com/api-reference/jobs/create)
