---
title: 'Redact PHI in audio and transcriptionu using Python SDK'
...
<CardGroup cols={1}>
  <Card
    title="Python SDK"
    icon="python"
    href="https://github.com/Nijta-API/voice-harbor-client/blob/main/python/README.md"
  >
...
job_params = {
    "agents": ["health-generic"],  # Define agents for PHI redaction
    "model": "advanced",
